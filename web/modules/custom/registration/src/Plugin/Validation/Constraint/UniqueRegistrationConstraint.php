...
class UniqueRegistrationConstraint extends Constraint
{
    ...
    public $notUnique = 'User %username has already created an Event Report for the %eventname Event.
    You can find a link to the existing report on your account page under the "This user\'s content" section';
