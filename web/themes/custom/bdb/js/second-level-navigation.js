...
((Drupal) => {
  ...
  Drupal.bdb.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.bdb.isDesktopNav()) return;
  ...
  Drupal.bdb.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.bdb.areAnySubNavsOpen = areAnySubNavsOpen;
