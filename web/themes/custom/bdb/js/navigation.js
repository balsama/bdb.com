...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.bdb.areAnySubNavsOpen()) {
          props.bdb.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.bdbNavigation = {
    attach(context) {
